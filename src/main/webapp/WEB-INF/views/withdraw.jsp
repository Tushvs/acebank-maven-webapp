...
<head>
    <meta charset="UTF-8">
    <title>Withdraw Money | AceBank</title>
...
<!-- CARD -->
<div class="withdraw-card text-center">

    <h3 class="fw-bold mb-3">Withdraw Money</h3>
    <p class="text-secondary mb-4">
        Withdraw funds securely from your account
    </p>
    ...
    <form action="<%= request.getContextPath() %>/withdraw" method="post">
        ...
        <button type="submit" class="btn btn-withdraw w-100 py-2">
            Withdraw Now
        </button>
